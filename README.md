# Angular Boot Camp example: control-flow
...
**[StackBlitz for control-flow](https://stackblitz.io/github/AngularBootCamp/control-flow)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/control-flow.git
cd control-flow
npm install
npm start
```
